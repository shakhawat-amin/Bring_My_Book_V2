    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (context.UserInfo.Any(userIsExist => userIsExist.phoneNumber.Equals(model.phoneNumber)))
                {
                ...
                {
                    ModelState.AddModelError("RegistrationNumber", "Registration number can not be null");
                }

                if (model.Role == "Teacher" && model.Designation == null)
                {
               ...
               // check = true;                                                                       
                ...
                context.UserInfo.Add(usermodel);                                    // If everything is right then, adding to database
